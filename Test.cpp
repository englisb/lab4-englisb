...
#include "D:/2SH4_Fall2022/Lab4/cute/cute.h"
#include "D:/2SH4_Fall2022/Lab4/cute/ide_listener.h"
#include "D:/2SH4_Fall2022/Lab4/cute/xml_listener.h"
#include "D:/2SH4_Fall2022/Lab4/cute/cute_runner.h"
#include "Matrix.h"
#include <iostream>
...
void testConstructor1Invalid3() {
		// for constructor1
		int invalid_row3 = 0, invalid_col3 = 1;
		string expected="0 \n0 \n0 \n";
		Matrix b = Matrix(invalid_row3,invalid_col3);
...
void testConstructor2CornerCase() {
	  // for constructor2
	    int row=1,col=1;
        int data[1][1] = {{1}};
        int*input_data[1];
...
void testSetElementCornerCase() {
	  int value = 100;
	  int setinvalid_row = 4, setinvalid_col = 5;
	  int row=4,col=5;
      int data[4][5] = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
	  int*input_data[4];
	    for (int i=0;i<4;i++){
...
void testAddToInvalid2() {
	   ...
	   /*Add-to Matrix*/
	    int row_to_add=4; int col_to_add=6;


		int add_to_data[4][6] = {{3,4,5,6,7,8}, {1,2,3,4,5,6}, {0,0,0,0,0,0},{1,2,1,2,1,2}}; // add to 'data' matrix, dimension is greater than data matrix this time
...
void testSubMatrixCornerCase() {


	int subinvalid_row = 4, subinvalid_col = 5;
...
void testIsUpperTrTrueSquare() {
		//test isUpperTr()


	  int row=3,col=3;
      int upper1[3][3] = {{1,4,5},{0,9,8},{0,0,7}};
	  int*input_upper1[3];
	  for (int i=0;i<3;i++){
	    	input_upper1[i]=upper1[i];
	  }
